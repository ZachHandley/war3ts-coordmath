...
function transpile({ program, sourceFiles: targetSourceFiles, customTransformers = {}, plugins: pluginsFromOptions = [], emitHost = ts.sys, }) {
    ...
    const plugins = plugins_1.getPlugins(program, diagnostics, pluginsFromOptions);
    ...
    const transformers = transformers_1.getCustomTransformers(program, diagnostics, customTransformers, processSourceFile);
