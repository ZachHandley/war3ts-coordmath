...
function hasDefaultExportModifier(node) {
    var _a;
    return (_a = node.modifiers, (_a !== null && _a !== void 0 ? _a : [])).some(modifier => modifier.kind === ts.SyntaxKind.DefaultKeyword);
}
...
function getExportedSymbolsFromScope(context, scope) {
    ...
    if (((_a = scopeSymbol) === null || _a === void 0 ? void 0 : _a.exports) === undefined) {
        return [];
    }
