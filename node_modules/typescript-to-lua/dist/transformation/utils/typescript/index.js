...
function getFirstDeclarationInFile(symbol, sourceFile) {
    var _a, _b;
    const originalSourceFile = (_a = ts.getParseTreeNode(sourceFile), (_a !== null && _a !== void 0 ? _a : sourceFile));
    const declarations = (_b = symbol.getDeclarations(), (_b !== null && _b !== void 0 ? _b : [])).filter(d => d.getSourceFile() === originalSourceFile);
...
function inferAssignedType(context, expression) {
    var _a;
    return _a = context.checker.getContextualType(expression), (_a !== null && _a !== void 0 ? _a : context.checker.getTypeAtLocation(expression));
}
