...
exports.transformNewExpression = (node, context) => {
    ...
    if (annotations.has(annotations_1.AnnotationKind.Extension) || annotations.has(annotations_1.AnnotationKind.MetaExtension)) {
        throw errors_1.InvalidNewExpressionOnExtension(node);
    }
    ...
    if (customConstructorAnnotation) {
        if (customConstructorAnnotation.args[0] === undefined) {
            throw errors_1.InvalidAnnotationArgumentNumber("@customConstructor", 0, 1, node);
        }
        return lua.createCallExpression(lua.createIdentifier(customConstructorAnnotation.args[0]), call_1.transformArguments(context, (_a = node.arguments, (_a !== null && _a !== void 0 ? _a : []))), node);
    }
