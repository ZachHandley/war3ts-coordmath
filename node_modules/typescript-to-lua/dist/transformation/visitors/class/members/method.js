...
function transformMethodDeclaration(context, node, className, noPrototype) {
    ...
    const functionExpression = lua.createFunctionExpression(lua.createBlock(body), paramNames, dots, restParamName, lua.FunctionExpressionFlags.Declaration, node.body);
