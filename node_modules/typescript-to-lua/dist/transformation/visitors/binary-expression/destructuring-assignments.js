...
function transformDestructuringAssignment(context, node, root) {
    switch (node.left.kind) {
        case ts.SyntaxKind.ObjectLiteralExpression:
            return transformObjectDestructuringAssignment(context, node, root);
        case ts.SyntaxKind.ArrayLiteralExpression:
            return transformArrayDestructuringAssignment(context, node, root);
    }
}
exports.transformDestructuringAssignment = transformDestructuringAssignment;
function transformArrayDestructuringAssignment(context, node, root) {
    ...
    return node.elements.flatMap((element, index) => {
        ...
        switch (element.kind) {
            ...
            case ts.SyntaxKind.OmittedExpression:
                return [];
            default:
                throw errors_1.UnsupportedKind("Array Destructure Assignment Element", element.kind, element);
        }
    });
}
function transformObjectDestructuringAssignment(context, node, root) {
    ...
    for (const property of node.properties) {
        switch (property.kind) {
            ...
            case ts.SyntaxKind.SpreadAssignment:
                ...
                break;
            default:
                throw errors_1.UnsupportedKind("Object Destructure Property", property.kind, property);
        }
    }
    return result;
}
