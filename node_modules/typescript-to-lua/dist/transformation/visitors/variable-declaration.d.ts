...
export declare function transformArrayBindingElement(context: TransformationContext, name: ts.ArrayBindingElement | ts.Expression): lua.Identifier;
...
export declare function checkVariableDeclarationList(node: ts.VariableDeclarationList): void;
