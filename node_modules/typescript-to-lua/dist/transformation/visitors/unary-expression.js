...
exports.transformPostfixUnaryExpression = (expression, context) => {
    switch (expression.operator) {
        ...
        default:
            throw errors_1.UnsupportedKind("unary postfix operator", expression.operator, expression);
    }
};
exports.transformPrefixUnaryExpression = (expression, context) => {
    switch (expression.operator) {
        ...
        default:
            throw errors_1.UnsupportedKind("unary prefix operator", expression.operator, expression);
    }
};
