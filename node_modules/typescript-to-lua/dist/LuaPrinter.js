...
class LuaPrinter {
    ...
    printImplementation(block, luaLibFeatures) {
        ...
        const luaLibImport = (_a = this.options.luaLibImport, (_a !== null && _a !== void 0 ? _a : CompilerOptions_1.LuaLibImportKind.Require));
    ...
    printTableFieldExpression(expression) {
        ...
        if (expression.key) {
            if (lua.isStringLiteral(expression.key) &&
                safe_names_1.isValidLuaIdentifier(expression.key.value) &&
                !safe_names_1.luaKeywords.has(expression.key.value)) {
    ...
    printTableIndexExpression(expression) {
        ...
        if (lua.isStringLiteral(expression.index) &&
            safe_names_1.isValidLuaIdentifier(expression.index.value) &&
            !safe_names_1.luaKeywords.has(expression.index.value)) {
