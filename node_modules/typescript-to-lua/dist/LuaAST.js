...
function createBooleanLiteral(value, tsOriginal) {
    if (value) {
        return createNode(SyntaxKind.TrueKeyword, tsOriginal);
    }
    else {
        return createNode(SyntaxKind.FalseKeyword, tsOriginal);
    }
}
...
function createFunctionExpression(body, params, dots, restParamName, flags = FunctionExpressionFlags.None, tsOriginal) {
